package com.loserexe.packets.slp.serverbound;
...
public class Handshake {
    ...
    public static byte [] getHandshakePacket(int serverPort, String serverAddress, int protocolVersion) throws IOException {
